package com.awin.configuration;
...
public class SwaggerConfig
{
    ...
    public void postConstruct() throws ClassNotFoundException {
        ...
        for (BeanDefinition beanDef : provider.findCandidateComponents("com.awin.resources")) {
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                .title("job Appliction Services")
                .description("Endpoints related to upload Services")
                .version("1.0")
                .contact(new Contact("Alok Maurya", "+91 9871140148", "alokmaurya05@gmail.com"))
                .build();
    }
